...
namespace ast
{
    ...
    public:
        ...
        TypePtr clone() const override
        {
            ...
            return std::make_shared<GenericType>(token, name, clonedArgs);
        }
    ...
    public:
        ...
        TypePtr clone() const override
        {
            return std::make_shared<TypeParameterType>(token, name);
        }
    ...
    public:
        ...
        TypePtr clone() const override
        {
            return std::make_shared<TraitType>(token, name);
        }
    ...
    public:
        ...
        TypePtr clone() const override
        {
            std::vector<TypePtr> clonedParamTypes;
            for (const auto &paramType : paramTypes)
            {
                clonedParamTypes.push_back(paramType->clone());
            }
            return std::make_shared<FunctionType>(token, clonedParamTypes, returnType->clone());
        }
