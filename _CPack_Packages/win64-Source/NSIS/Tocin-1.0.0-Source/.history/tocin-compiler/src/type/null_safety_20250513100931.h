...
namespace type_checker
{
    ...
    public:
        ...
        ast::TypePtr makeNullable(ast::TypePtr type)
        {
            ...
            return std::make_shared<ast::NullableType>(type);
        }
    ...
    /**
     * @brief AST node for a nullable type
     *
     * Represents a type that can be null (Type?).
     */
    class NullableType : public ast::Type
    {
    public:
        ast::TypePtr baseType; // The underlying type

        NullableType(ast::TypePtr baseType)
            : baseType(baseType) {}
