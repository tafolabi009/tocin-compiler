...
namespace type_checker
{
    ...
    public:
        ...
        {
            visitor.visitFunctionStmt(static_cast<ast::FunctionStmt *>(this));
        }
        ...
        const std::vector<ast::Parameter> &getParameters() const { return parameters; }
        ast::TypePtr getReturnType() const { return returnType; }
        ast::StmtPtr getBody() const { return body; }
