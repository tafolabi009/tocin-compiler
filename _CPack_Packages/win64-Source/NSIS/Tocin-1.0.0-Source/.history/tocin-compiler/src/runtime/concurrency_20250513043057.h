...
namespace runtime
{
    ...
    // Forward declare specialized versions as well
    template <>
    class Future<void>;
    ...
    {
    public:
        Promise() : future(std::make_shared<typename Future<void>::State>()) {}
    ...
    private:
        std::shared_ptr<typename Future<void>::State> future;
    };
    ...
    private:
        ...
        // Allow Promise and Future<void> to access the state
