...
// Forward declare these types, the proper include happens later in the actual implementation files
namespace type_checker { class MoveExpr; }
namespace runtime {
    class GoExpr;
...
namespace ast
{
    ...
    public:
        ...
        virtual void visitMoveExpr(type_checker::MoveExpr *expr) = 0;
        virtual void visitGoExpr(runtime::GoExpr *expr) = 0;
        virtual void visitRuntimeChannelSendExpr(runtime::ChannelSendExpr *expr) = 0;
        virtual void visitRuntimeChannelReceiveExpr(runtime::ChannelReceiveExpr *expr) = 0;
        virtual void visitRuntimeSelectStmt(runtime::SelectStmt *stmt) = 0;
