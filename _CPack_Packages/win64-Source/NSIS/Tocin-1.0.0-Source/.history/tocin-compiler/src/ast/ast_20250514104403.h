...
namespace ast
{
    ...
    public:
        ...
        virtual void visitChannelSendExpr(class ChannelSendExpr *expr) = 0;
        virtual void visitChannelReceiveExpr(class ChannelReceiveExpr *expr) = 0;
        virtual void visitSelectStmt(class SelectStmt *stmt) = 0;
