...
namespace lexer
{
    ...
    void Lexer::handleIndentation()
    {
        ...
        {
            errorHandler.reportError(error::ErrorCode::L001_INVALID_CHARACTER,
                                     "Mixed tabs and spaces in indentation", filename, line, column,
                                     error::ErrorSeverity::ERROR);
    ...
    void Lexer::scanNumber()
    {
        ...
        // Look for exponent
        if ((peek() == 'e' || peek() == 'E') &&
            (std::isdigit(peekNext()) || (peekNext() == '+' || peekNext() == '-') && std::isdigit(peek())))
        {
            isFloat = true;
    ...
    void Lexer::scanIdentifier()
    {
        ...
        TokenType type = keywords.count(value) > 0 ? keywords.at(value) : TokenType::IDENTIFIER;
    ...
    void Lexer::scanToken()
    {
        ...
        case '&':
            ...
            {
                errorHandler.reportError(error::ErrorCode::L001_INVALID_CHARACTER,
                                         "Unexpected character: &", filename, line, column - 1,
                                         error::ErrorSeverity::ERROR);
        ...
        default:
            errorHandler.reportError(error::ErrorCode::L001_INVALID_CHARACTER,
                                     "Unexpected character: " + std::string(1, c), filename, line,
