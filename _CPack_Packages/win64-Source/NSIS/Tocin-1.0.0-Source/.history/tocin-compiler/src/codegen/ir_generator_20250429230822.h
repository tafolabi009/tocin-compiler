...
namespace Tocin {
    ...
    class VariableDecl; class FunctionStmt; class ReturnStmt; class IfStmt;
    class WhileStmt; class BlockStmt; class ExpressionStmt; class LiteralExpr;
    class UnaryExpr; class BinaryExpr; class CallExpr; class VariableExpr;
    class AssignmentExpr; class LogicalExpr; class GroupingExpr;
