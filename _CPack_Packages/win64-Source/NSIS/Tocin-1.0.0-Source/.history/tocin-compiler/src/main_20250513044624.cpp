...
public:
                 ...
                 const CompilationOptions &options = CompilationOptions())
    {
        ...
        // Type checking
        type_checker::TypeChecker checker(errorHandler);
        ...
        // IR generation
        llvm::LLVMContext context;
        codegen::IRGenerator generator(errorHandler, context);
        ...
        {
            errorHandler.reportError(error::ErrorCode::C001_CODEGEN_ERROR,
        ...
        if (!options.outputFile.empty())
        {
            ...
            if (EC)
            {
                errorHandler.reportError(error::ErrorCode::I005_IO_ERROR,
