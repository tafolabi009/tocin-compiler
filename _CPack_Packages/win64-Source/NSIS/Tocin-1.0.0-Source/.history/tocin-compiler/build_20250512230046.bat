...
set INCLUDE_PATHS=-I../src -IC:/msys64/mingw64/include -IC:/msys64/mingw64/include/llvm
...
if exist ..\src\error\error_handler.cpp (
    set SOURCES=!SOURCES! ..\src\error\error_handler.cpp
)

REM Check if lexer files exist and add them
if exist ..\src\lexer\lexer.cpp (
    set SOURCES=!SOURCES! ..\src\lexer\lexer.cpp
)
if exist ..\src\lexer\token.cpp (
    set SOURCES=!SOURCES! ..\src\lexer\token.cpp
)

REM Check if parser files exist and add them
if exist ..\src\parser\parser.cpp (
    set SOURCES=!SOURCES! ..\src\parser\parser.cpp
)
