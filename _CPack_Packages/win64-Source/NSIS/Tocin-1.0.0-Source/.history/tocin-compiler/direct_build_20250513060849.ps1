...
# Compile IR generator with more detailed output
Write-Host "Compiling IR generator..."
$process = Start-Process -FilePath $CXX -ArgumentList @(
    "-c", "src/codegen/ir_generator.cpp", 
    "-o", "build/obj/ir_generator.o", 
    "-Isrc", "-I$LLVM_INCLUDE", 
    "-std=c++17", 
...
if ($process.ExitCode -ne 0) {
    Write-Host "Error: Failed to compile IR generator (Exit code: $($process.ExitCode))" -ForegroundColor Red
    exit 1
}
