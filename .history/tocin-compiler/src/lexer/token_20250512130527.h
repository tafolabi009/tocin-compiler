...
namespace lexer {
    ...
    enum class TokenType {
        ...
        LEFT_BRACKET, RIGHT_BRACKET, COMMA, DOT, SEMI_COLON, COLON,

        // One or two character tokens
        PLUS, PLUS_EQUAL, MINUS, MINUS_EQUAL, STAR, STAR_EQUAL,
        SLASH, SLASH_EQUAL, PERCENT, PERCENT_EQUAL, EQUAL, EQUAL_EQUAL,
        ...
        // Literals
        IDENTIFIER, STRING, INT, FLOAT64, FLOAT32,

        // Keywords
        LET, DEF, ASYNC, AWAIT, CLASS, IF, ELIF, ELSE,
        WHILE, FOR, IN, RETURN, IMPORT, FROM, MATCH,
        CASE, DEFAULT, CONST, TRUE, FALSE, NIL, LAMBDA, PRINT,
        NEW, DELETE,
