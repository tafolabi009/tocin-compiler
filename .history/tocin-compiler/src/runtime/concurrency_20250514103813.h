...
namespace runtime
{
    ...
    public:
        ...
        {
            return std::make_shared<ast::GenericType>(TYPE_NAME, std::vector<ast::TypePtr>{elementType});
        }
    ...
    public:
         ...
         */
        bool validateGoroutineLaunch(ast::ExprPtr funcExpr,
                                     const std::vector<ast::ExprPtr> &arguments)
        {
            if (!funcExpr)
            {
            ...
            if (!dynamic_cast<ast::CallExpr *>(funcExpr.get()) &&
                !dynamic_cast<ast::VariableExpr *>(funcExpr.get()))
            {
                errorHandler.reportError(
    ...
    public:
        ...
        bool validateChannelSend(ast::ExprPtr channelExpr, ast::ExprPtr valueExpr,
        ...
        bool validateChannelReceive(ast::ExprPtr channelExpr, ast::TypePtr channelType)
        {
            if (!channelExpr)
            {
                errorHandler.reportError(
     ...
     */
    class ChannelSendExpr : public ast::Expr
    {
    public:
     ...
     */
    class ChannelReceiveExpr : public ast::Expr
    {
    public:
     ...
     */
    class SelectStmt : public ast::Stmt
    {
    public:
        struct SelectCase
        {
