...
private:
    ...
    void optimizeModule(llvm::Module &module, int level)
    {
        ...
        {
            // Fix: Use supported method for O1
            MPM = PB.buildO0DefaultPipeline();
            // Add some basic optimizations manually if needed
        }
        else if (level == 2)
        {
            // Fix: Use supported method for O2
            MPM = PB.buildO0DefaultPipeline();
            // Add more aggressive optimizations manually if needed
        }
        else if (level == 3)
        {
            // Fix: Use supported method for O3
            MPM = PB.buildO0DefaultPipeline();
            // Add very aggressive optimizations manually if needed
        }
