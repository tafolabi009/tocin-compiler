...
{
    // TODO: Implement once type_checker::MoveExpr is fully integrated
    lastValue = nullptr;
    errorHandler.reportError(error::ErrorCode::C001_UNIMPLEMENTED_FEATURE,
                            "MoveExpr not yet implemented in IR generator",
                            "", 0, 0, error::ErrorSeverity::WARNING);
}

void IRGenerator::visitGoExpr(void *expr)
{
    // TODO: Implement once runtime::GoExpr is fully integrated
    lastValue = nullptr;
    errorHandler.reportError(error::ErrorCode::C001_UNIMPLEMENTED_FEATURE,
                            "GoExpr not yet implemented in IR generator",
                            "", 0, 0, error::ErrorSeverity::WARNING);
}

void IRGenerator::visitRuntimeChannelSendExpr(void *expr)
{
    // TODO: Implement once runtime::ChannelSendExpr is fully integrated
    lastValue = nullptr;
    errorHandler.reportError(error::ErrorCode::C001_UNIMPLEMENTED_FEATURE,
                            "Runtime ChannelSendExpr not yet implemented in IR generator",
                            "", 0, 0, error::ErrorSeverity::WARNING);
}

void IRGenerator::visitRuntimeChannelReceiveExpr(void *expr)
{
    // TODO: Implement once runtime::ChannelReceiveExpr is fully integrated
    lastValue = nullptr;
    errorHandler.reportError(error::ErrorCode::C001_UNIMPLEMENTED_FEATURE,
                            "Runtime ChannelReceiveExpr not yet implemented in IR generator",
                            "", 0, 0, error::ErrorSeverity::WARNING);
}

void IRGenerator::visitRuntimeSelectStmt(void *stmt)
{
    // TODO: Implement once runtime::SelectStmt is fully integrated
    lastValue = nullptr;
    errorHandler.reportError(error::ErrorCode::C001_UNIMPLEMENTED_FEATURE,
                            "Runtime SelectStmt not yet implemented in IR generator",
                            "", 0, 0, error::ErrorSeverity::WARNING);
}
