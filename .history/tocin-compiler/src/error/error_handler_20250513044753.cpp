...
namespace error
{
    ...
    std::string errorCodeToString(ErrorCode code)
    {
        ...
        case ErrorCode::L001_INVALID_CHARACTER:
            return "L001";
        case ErrorCode::L002_UNTERMINATED_STRING:
            return "L002";
        case ErrorCode::S001_UNEXPECTED_TOKEN:
            return "S001";
        case ErrorCode::S002_MISSING_EXPECTED_TOKEN:
            return "S002";
        case ErrorCode::T001_TYPE_MISMATCH:
            return "T001";
        case ErrorCode::T002_UNDEFINED_VARIABLE:
            return "T002";
        case ErrorCode::M001_DUPLICATE_DEFINITION:
            return "M001";
        case ErrorCode::M006_MODULE_NOT_FOUND:
            return "M006";
        case ErrorCode::F001_FFI_CALL_FAILED:
            return "F001";
        case ErrorCode::I001_FILE_NOT_FOUND:
            return "I001";
        case ErrorCode::C001_UNIMPLEMENTED_FEATURE:
            return "C001";
        case ErrorCode::C004_INTERNAL_ASSERTION_FAILED:
            return "C004";
        // ... other cases ...
        default:
