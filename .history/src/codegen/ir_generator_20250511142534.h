...
namespace ir_generator
{
    ...
    public:
        ...
        // Removed: void visitPrintStmt(ast::PrintStmt *stmt) override;
        // Removed: void visitVarStmt(ast::VarStmt *stmt) override;
        ...
        // Removed: void visitLogicalExpr(ast::LogicalExpr *expr) override;
        ...
        // Removed: void visitThisExpr(ast::ThisExpr *expr) override;
        // Removed: void visitSuperExpr(ast::SuperExpr *expr) override;
        ...
        // Removed: void visitArrayExpr(ast::ArrayExpr *expr) override;
        // Removed: void visitIndexExpr(ast::IndexExpr *expr) override;
        // Removed: void visitOptionExpr(ast::OptionExpr *expr) override;
        // Removed: void visitResultExpr(ast::ResultExpr *expr) override;
    ...
    private:
        ...
        // Removed: llvm::Type *getLLVMType(std::shared_ptr<type::Type> tocinType);
